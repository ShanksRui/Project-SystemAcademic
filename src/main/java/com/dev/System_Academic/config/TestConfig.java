...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
	    ...
	    studentRepository.saveAll(Arrays.asList(stu1, stu2, stu3, stu4));
	...
	co1.getStudents().addAll(Arrays.asList(stu2,stu3));
	co2.getStudents().addAll(Arrays.asList(stu1,stu4));
    courseRepository.saveAll(Arrays.asList(co1, co2));
