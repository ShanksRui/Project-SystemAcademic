...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
	 ...
	 Enrollment en1 = new Enrollment(null, StatusSubject.INPROGRESS,stu1);
	 Enrollment en2 = new Enrollment(null, StatusSubject.COMPLETED,stu2);
	 Enrollment en3 = new Enrollment(null, StatusSubject.FAILED,stu1);
	 Enrollment en4 = new Enrollment(null, StatusSubject.INPROGRESS,stu3);	 
	 Enrollment en5 = new Enrollment(null, StatusSubject.COMPLETED,stu2);
	 Enrollment en6 = new Enrollment(null, StatusSubject.INPROGRESS,stu3);
	 Enrollment en7 = new Enrollment(null, StatusSubject.COMPLETED,stu3);
	 ...
	 Course co2 = new Course(null, "Computer science", 145.0, 0.3,Instant.parse("2023-10-27T10:00:00Z"));
	 co1.getSubjects().addAll(Arrays.asList(sub1,sub4,sub3));
	 co2.getSubjects().addAll(Arrays.asList(sub2,sub5));
